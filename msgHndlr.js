...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        case '#nyanyi':
        case '#play':
            if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa di gunakan dalam group dan bisa di gunakan pribadi apabila sudah upgrade premium dengan ketik !menu !', id)
            ...
            const playy = await get.get(`http://nczcha-apii-apii.herokuapp.com/ytsearch?q=${encodeURIComponent(body.slice(8))}`).json()
...
➸ *Durasi:* ${duration}`
        ...
        case '#say':
            if (!isGroupMsg) return client.reply(from, 'Perintah ini hanya bisa di gunakan dalam group dan bisa di gunakan pribadi apabila sudah upgrade premium dengan ketik !menu !', id)
            const tai = body.slice(4)
            client.reply(from, tai, id)
            break
...
WHATSAPP   : https://wa.me/6281289096745\nJangan Lupa bantu subscribe follow ya ${pushname}`, id)
    ...
    case '#gets':
        ...
        case '#link':
            const linky = 'SCRIPT\n - RIDHO BOT : https://semawur.com/glPGR\n - WARIDHOBOT : https://semawur.com/WgIR\n - WARIDHOBOT-MAIN : https://semawur.com/YEXUU\n - WHATSAPP-BOT-MASTER : https://semawur.com/YcTa\n - NODE-v14.15.1-x64 : https://semawur.com/S0fdXT\n - 500+ PRRSET LIGHTROOM : https://semawur.com/QIUGE\n - SC PHISING FB KUIS : https://semawur.com/VewhqobXuF\n - SC PHISING SCART TITAN FF : https://semawur.com/7GpixqEL8\n - SC FB TOOLS LENGKAP : https://semawur.com/mmwHR2ADc'
            client.reply(from, linky, id)
            break
